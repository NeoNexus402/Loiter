# Loiter Dev Guide (fork of Metrolist)

This file outlines the process of setting up a local dev environment for Loiter (forked from Metrolist).
...
```bash
git clone https://github.com/NeoNexus402/Loiter
cd Loiter
