# Working with Loiter as an AI agent

Loiter is a 3rd party YouTube Music client written in Kotlin (forked from Metrolist). It follows material 3 design guidelines closely.
