...
val baseApplicationId = "com.loiter.music"
val applicationIdOverride = System.getenv("LOITER_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("LOITER_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("LOITER_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("LOITER_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("LOITER_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("LOITER_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Loiter Debug")
            }
            signingConfig =
