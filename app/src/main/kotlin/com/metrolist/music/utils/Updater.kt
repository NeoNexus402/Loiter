...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/NeoNexus402/Loiter"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Loiter.apk" -> "universal" to "foss"
                name == "Loiter-with-Google-Cast.apk" -> "universal" to "gms"
